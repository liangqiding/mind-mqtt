...
public class PublishQos2Task extends PublishTask {
    ...
    void publishTask(Message message, long delay) {
        ...
        // 发送publish消息
        ChannelManage.sendByCid(message.getToClientId(), MqttMessageBuilder.newPublishMessage(message));
        // 继续添加下一次的延时发送
    ...
    public void start(Message message) {
        ...
        super.addSchedule(message, DELAY_TIME);
    }
