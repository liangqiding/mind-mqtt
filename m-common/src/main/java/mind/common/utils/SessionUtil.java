...
//     * obj转换成json
//     */
//    public static final Function<Object, JSONObject> TO_JSON = obj -> JSON.parseObject(JSON.toJSONString(obj));
//
//    /**
//     * json转换成实体
//     */
//    private static final Function<JSONObject, T> TO_MQTT_SESSION = mqttSession -> JSON.parseObject(mqttSession.toJSONString(), MqttSession.class);
//
//    /**
//     * 判断是否需要特殊序列化
//     */
